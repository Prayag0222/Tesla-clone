      ...
      <div className="container mx-auto">
        <div className="w-full aspect-[16/7] relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-start text-center bg-black/30 md:bg-transparent">
            ...
            <span className="text-base sm:text-lg md:text-xl font-medium underline underline-offset-4 decoration-2 text-white px-2 md:px-4 py-1 rounded">
            ...
            <div className="absolute bottom-47 left-0 right-0 flex justify-center items-center gap-2">
              {images.map((img, idx) => (
                <button
                  key={idx}
